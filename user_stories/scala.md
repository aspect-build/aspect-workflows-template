...
~~~sh
aspect build --task:name build-scala-story --github-status-comments:enabled=false --github-status-checks:enabled=false //hello/scala:hello
aspect test --task:name test-scala-story --github-status-comments:enabled=false --github-status-checks:enabled=false //hello/scala:hello_test
...
~~~sh
aspect build --task:name build-scala-greet --github-status-comments:enabled=false --github-status-checks:enabled=false //src/greet:greet
